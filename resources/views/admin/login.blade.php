                ...
                <div class="col-md-7 col-lg-5">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="{{ route('Alogindata') }}" method="POST" class="login-form">
                            ...
                            <div class="form-group">
                                <div class="icon d-flex align-items-center justify-content-center"
                                    style="background-color: #D19C97"><span class="fa fa-lock"></span></div>
                            ...
                            <div class="form-group d-flex align-items-center">
                                <div class="w-100">
                                    <label class="checkbox-wrap checkbox-primary mb-0" style="color: #D19C97">Save
                                        Password
                                        <input type="checkbox" checked>
                                        <span class="checkmark" style="background-color: #D19C97"></span>
                                    </label>
                                </div>
                            ...
                            <div class="form-group mt-4">
                                <div class="w-100 text-center">
                                    <p class="mb-1">Don't have an account? <a href="{{ route('Admin-Reg') }}"
                                            style="color: #D19C97">Sign Up</a></p>
                                    <p><a href="{{ route('Aforgetemail') }}" style="color: #D19C97">Forgot Password</a>
                                    </p>
                                </div>
                            </div>
                        </form>
