                    ...
                    <p class="" style="">
                        ...
                        @if (!session()->has('ULogin'))
                            ...
                            <a class="" style="color:black;margin-left:20px;text-decoration:none"
                                href="{{ route('Freg') }}"><i class="fa-solid fa-users"
                                    style="font-size:12px;"></i>&nbsp Registration</a>
                        @else
                            ...
                            <div class="dropdown">
                                <a class="dropbtn" style="color:black;text-decoration:none" href=""><i
                                        class="fa-solid fa-user"></i>&nbsp My Account <i
                                        class="fa-solid fa-chevron-down" style="font-size:12px;"></i></a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Colorful Stylish Boys Kurtas</h6>
        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p>Explore kids and baby products galore at BabyHub.com, the Big Store for Little Ones.<br><br>
                    We at BabyHub.com
                    empathize with you as a mother who always aspires to bestow her newborn, infant, baby or kid with
                    the
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="{{ route('Fshop') }}"><i
                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        ...
                        <div class="row gallery">
                            <div class="col-6">
                                <a href="#"><img src="ClientCss\img\cloths\frock1.jpg" alt="Image" class="img-fluid"></a>
                                <a href="#"><img src="ClientCss\img\cloths\bshirt1.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-6">
                                <a href="#"><img src="ClientCss\img\cloths\gdungree1.jpg" alt="Image" class="img-fluid"></a>
