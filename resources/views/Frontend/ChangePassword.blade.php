                                    ...
                                    <div class="card-body p-4" style="background-color: rgb(241, 241, 241 )">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-outline datepicker w-100">
                                                ...
                                                <input type="password" style="border-radius: 5px" name="currentpass" id="currentpass"
                                        ...
                                        <input type="password"  style="border-radius: 5px" name="confirmpass" class="form-control form-control-lg mb-3" id="birthdayDate" />
                                    </div>
                                        </div>
